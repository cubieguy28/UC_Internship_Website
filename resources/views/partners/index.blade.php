...
<div class="p-5">
	...
	<h1 class="text-3xl italic font-bold tracking-wider mb-16 text-center" style="color: #003d13;font-variant: small-caps;">Industry Partners</h1>
		...
		<div class="rounded-lg flex text-center grid justify-items-center">
			<div class="grid justify-items-center">
				...
				<div class="flex grid gap-2 grid-cols-2 rounded-lg p-3" style="color: #003d13; ">
					<div class="flex justify-center items-center rounded-lg bg-gray-100">
