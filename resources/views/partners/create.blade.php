...
<div class="p-5 flex flex-wrap content-center">
			...
			<div class="w-full max-w-xs">
			  ...
			  <form action="/partners" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			    ...
			    <div class="mb-4">
			    	...
			    	<input type="file" class="w-full text-gray-700 px-3 py-2 border rounded" id="partner_image" name="partner_image">
			    </div>
