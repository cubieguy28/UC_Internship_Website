    ...
    <div class="w-1/3">
      <form action="/search" method="get">
        <div class="flex items-center w-2/3 ml-10">
          ...
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="search" type="search" name="search" placeholder="Search">
    ...
    <div class="w-1/3">
      <form action="/filter" method="get">
        <div class="flex items-center w-full">
          ...
          <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="filter-by-year" name="filter-by-year">
            <option class="py-1" disabled selected value>Filter by year</option>
          </select>

          <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ml-4" id="filter-by-category" name="filter-by-category">
