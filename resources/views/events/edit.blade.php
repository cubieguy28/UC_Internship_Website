		...
		<div class="w-full max-w-xs">
			<form action="/testimonials/{{ $testimonial->id }}" method="POST">
				...
				<div class="mb-4">
			      ...
			      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="event_name" name="event_name" type="text" placeholder="Name" value="{{ $event->event_name }}">
			    </div>
			    ...
			    <div class="mb-4">
			      ...
			      <textarea class="shadow appearance-none border rounded w-full py-5 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="event_description" name="event_description">{{ $event->event_description }}</textarea>
			    </div>
			    ...
			    <div class="mb-4">
			      ...
			      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="event_speaker_fname" name="event_speaker_fname" type="text" placeholder="Event Speaker Last Name" value="{{ $event->event_speaker_fname }}">
			    </div>
				...
				<div class="mb-4">
			      ...
			      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="event_speaker_lname" name="event_speaker_lname" type="text" placeholder="Event Speaker Last Name" value="{{ $event->event_speaker_lname }}">
			    </div>
			    ...
			    <div class="mb-4">
			      ...
			      <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="event_category" name="event_category" selected="{{ $event->event_category }}">
			    ...
			    <div class="mb-4">
			    	<label class="block text-gray-700 text-sm font-bold mb-2" for="event_date">Event Date</label>
  					<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="date" id="event_date" name="event_date" value="{{ $event->event_date }}">
			    </div>
			    ...
			    <div class="mb-4">
			    	...
			    	<input type="file" class="w-full text-gray-700 px-3 py-2 border rounded" id="event_image" name="event_image" value="{{ $event->event_image }}">
			    </div>
